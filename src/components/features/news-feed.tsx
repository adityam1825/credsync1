...
export default function NewsFeed() {
  ...
  useEffect(() => {
    // Initial shuffle on client-side to avoid hydration mismatch
  ...
  const handleRefresh = () => {
    ...
    setArticles(shuffleArray(mockNews));
    // Changing the key to force a re-render of the grid
  ...
  return (
    <div className="space-y-6">
        ...
        <div key={refreshKey} className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 animate-in fade-in-50">
